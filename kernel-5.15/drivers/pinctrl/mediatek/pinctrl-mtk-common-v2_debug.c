...
/*<lct.mazhilin 20241206 Add the three state requirement for DRDI according to the MTK solution.  > start*/
//	pin -= hw->chip.base;
//	if (pin >= hw->soc->npins) {
	if (pin - hw->chip.base >= hw->soc->npins) {
/*<lct.mazhilin 20241206 Add the three state requirement for DRDI according to the MTK solution.  > end*/
...
/*<lct.mazhilin 20241206 Add the three state requirement for DRDI according to the MTK solution.  > start*/
EXPORT_SYMBOL(gpio_get_tristate_input);
/*<lct.mazhilin 20241206 Add the three state requirement for DRDI according to the MTK solution.  > end*/
