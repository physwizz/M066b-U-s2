...
#include "sc820cs_truly_mipiraw_Sensor.h"
#define PFX "sc820cs_truly_camera_sensor"
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 000, 000, 3264, 2448, 0, 0, 3264, 2448},  // Preview
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 000, 000, 3264, 2448, 0, 0, 3264, 2448},  // capture
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 000, 304, 3264, 1840, 0, 0, 3264, 1840},  // video
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 000, 000, 3264, 2448, 0, 0, 3264, 2448},  // hight speed video
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 000, 000, 3264, 2448, 0, 0, 3264, 2448},  // slim video
};
...
static kal_uint32 open(void) {
	...
	LOG_INF(
		"preview 1632*1224@30fps,660Mbps/lane;"
...
static kal_uint32 set_test_pattern_mode(kal_bool enable) {
	...
	if (enable) {
		...
		write_cmos_sensor8(0x5000, value | 0x06);
