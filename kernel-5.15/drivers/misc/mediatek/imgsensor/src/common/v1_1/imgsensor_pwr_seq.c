...
/* M197 Camera begin */
#if defined(HI5022_TRULY_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI5022_TRULY_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_High, 3},
...
#endif
#if defined(GC08A8_CXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC08A8_CXT_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_High, 3},
...
#endif
#if defined(BF2257CS_CXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_BF2257CS_CXT_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_High, 3},
...
#endif
#if defined(S5KJN1_TXD_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1_TXD_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_High, 1},
			...
			{AFVDD, Vol_High, 3},
			{RST, Vol_High, 1},
			{SensorMCLK, Vol_High, 12},
		},
	},
#endif
#if defined(SC820CS_TRULY_SENSOR_ID)
	{
...
#endif
#if defined(SC202CS_UNIMAGE_MIPI_RAW)
	{
		SENSOR_DRVNAME_SC202CS_UNIMAGE_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_High, 1},
...
#endif
#if defined(MT815_KINGCOME_MIPI_RAW)
	{
		SENSOR_DRVNAME_MT815_KINGCOME_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DVDD, Vol_High, 1},
			{DOVDD, Vol_1800, 1},
