...
{HI5022_TRULY_SENSOR_ID, SENSOR_DRVNAME_HI5022_TRULY_MIPI_RAW, HI5022_TRULY_MIPI_RAW_SensorInit},
#endif
#if defined(GC08A8_CXT_MIPI_RAW)
{GC08A8_CXT_SENSOR_ID, SENSOR_DRVNAME_GC08A8_CXT_MIPI_RAW, GC08A8_CXT_MIPI_RAW_SensorInit},
#endif
#if defined(BF2257CS_CXT_MIPI_RAW)
{BF2257CS_CXT_SENSOR_ID, SENSOR_DRVNAME_BF2257CS_CXT_MIPI_RAW, BF2257CS_CXT_MIPI_RAW_SensorInit},
#endif
#if defined(S5KJN1_TXD_MIPI_RAW)
{S5KJN1_TXD_SENSOR_ID, SENSOR_DRVNAME_S5KJN1_TXD_MIPI_RAW, S5KJN1_TXD_MIPI_RAW_SensorInit},
#endif
#if defined(SC820CS_TRULY_MIPI_RAW)
{SC820CS_TRULY_SENSOR_ID, SENSOR_DRVNAME_SC820CS_TRULY_MIPI_RAW, SC820CS_TRULY_MIPI_RAW_SensorInit},
#endif
#if defined(SC202CS_UNIMAGE_MIPI_RAW)
{SC202CS_UNIMAGE_SENSOR_ID, SENSOR_DRVNAME_SC202CS_UNIMAGE_MIPI_RAW, SC202CS_UNIMAGE_MIPI_RAW_SensorInit},
#endif
#if defined(MT815_KINGCOME_MIPI_RAW)
{MT815_KINGCOME_SENSOR_ID, SENSOR_DRVNAME_MT815_KINGCOME_MIPI_RAW, MT815_KINGCOME_MIPI_RAW_SensorInit},
#endif
/* M197 Camera end */
