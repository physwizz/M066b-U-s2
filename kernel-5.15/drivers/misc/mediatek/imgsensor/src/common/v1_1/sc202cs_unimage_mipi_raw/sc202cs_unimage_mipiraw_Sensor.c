...
#include "sc202cs_unimage_mipiraw_Sensor.h"


#define PFX "sc202cs_unimage_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC202CS_UNIMAGE_SENSOR_ID,
...
static kal_uint32 set_video_mode(UINT16 framerate) {  // This Function not used after ROME
	LOG_INF("framerate = %d\n ", framerate);
...
UINT32 SC202CS_UNIMAGE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT** pfFunc) {
