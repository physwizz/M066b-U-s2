...
#include "mt815_kingcome_mipiraw_Sensor.h"

#define PFX "mt815_kingcome_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MT815_KINGCOME_SENSOR_ID,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if (enable)
    {
        ...
        write_cmos_sensor(0x05f1, 0x06);
        write_cmos_sensor(0x05f2, 0x01);
        write_cmos_sensor(0x05f3, 0xd0);
        write_cmos_sensor(0x05f4, 0xfa);
        write_cmos_sensor(0x05f5, 0x01);
...
UINT32 MT815_KINGCOME_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    LOG_INF("MT815_KINGCOME_MIPI_RAW_SensorInit\n");
    if (pfFunc!=NULL)
            *pfFunc=&sensor_func;
    return ERROR_NONE;
}
