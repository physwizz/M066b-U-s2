 ...
 */
#define PFX "gc08a8_cxt_camera_sensor"
...
#include "gc08a8cxtmipi_Sensor.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A8_CXT_SENSOR_ID,
...
{
	pr_debug("[%s] hs_video_Start, 3264x2448@90.29fps\n", __func__);
	table_write_cmos_sensor(gc08a8_3264x2448_addr_data,
		sizeof(gc08a8_3264x2448_addr_data)/sizeof(kal_uint16));
...
UINT32 GC08A8_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
