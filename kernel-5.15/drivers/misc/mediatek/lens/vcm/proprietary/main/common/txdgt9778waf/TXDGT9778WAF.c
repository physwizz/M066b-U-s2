...
/*
 * TXDGT9778WAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "TXDGT9778WAF_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		ret = s4AF_WriteReg(0, 0x07, 0x2C); //Tvib=10.7ms
...
/* ////////////////////////////////////////////////////////////// */
long TXDGT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TXDGT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int TXDGT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int TXDGT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TXDGT9778WAF_GetFileName(unsigned char *pFileName)
{
