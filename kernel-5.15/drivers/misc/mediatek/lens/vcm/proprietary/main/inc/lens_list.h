...
/*M197 CAMERA START*/
#define TRULYGT9778WAF_SetI2Cclient TRULYGT9778WAF_SetI2Cclient_Main
#define TRULYGT9778WAF_Ioctl TRULYGT9778WAF_Ioctl_Main
#define TRULYGT9778WAF_Release TRULYGT9778WAF_Release_Main
#define TRULYGT9778WAF_PowerDown TRULYGT9778WAF_PowerDown_Main
#define TRULYGT9778WAF_GetFileName TRULYGT9778WAF_GetFileName_Main
extern int TRULYGT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long TRULYGT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int TRULYGT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int TRULYGT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int TRULYGT9778WAF_GetFileName(unsigned char *pFileName);

#define TXDGT9778WAF_SetI2Cclient TXDGT9778WAF_SetI2Cclient_Main
#define TXDGT9778WAF_Ioctl TXDGT9778WAF_Ioctl_Main
#define TXDGT9778WAF_Release TXDGT9778WAF_Release_Main
#define TXDGT9778WAF_PowerDown TXDGT9778WAF_PowerDown_Main
#define TXDGT9778WAF_GetFileName TXDGT9778WAF_GetFileName_Main
extern int TXDGT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long TXDGT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int TXDGT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int TXDGT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int TXDGT9778WAF_GetFileName(unsigned char *pFileName);
/*M197 CAMERA END*/
