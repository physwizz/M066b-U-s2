...
/*
 * TRULYGT9778WAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "TRULYGT9778WAF_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		ret = s4AF_WriteReg(0, 0x06, 0x61);
		ret = s4AF_WriteReg(0, 0x07, 0x2F);
...
/* ////////////////////////////////////////////////////////////// */
long TRULYGT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TRULYGT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int TRULYGT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int TRULYGT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TRULYGT9778WAF_GetFileName(unsigned char *pFileName)
{
