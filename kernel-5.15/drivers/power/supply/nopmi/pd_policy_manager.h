...
#define QUICK_RAISE_VOLT_INTERVAL_S	12 * MSEC_PER_SEC

#define BQ_TAPER_FCC_VOTER	"BQ_TAPER_FCC_VOTER"
#define JEITA_VOTER		"JEITA_VOTER"
#define BATT_STEP_FCC_VOTER	"BATT_STEP_FCC_VOTER"
...
struct usbpd_pm {
    ...
    struct work_struct usbpd_psy_notifier_work;
