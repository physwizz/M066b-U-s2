...
#define VERIFY_BAT			5500	 //FCC limit to 5.5A
...
struct nopmi_chg {
	...
	struct device_attribute attr_afc_disable;
	struct device_attribute attr_usb_real_type;
	struct device_attribute attr_real_type;
        struct device_attribute attr_typec_mode;
        struct device_attribute typec_cc_orientation;
        struct device_attribute attr_resistance_id;
        struct device_attribute attr_input_suspend;
        struct device_attribute attr_quick_charge_type;
        struct device_attribute attr_mtbf_current;
        struct device_attribute attr_thermal_level;
        struct device_attribute attr_fg_batt_id;
        struct device_attribute attr_cycle_count_select;
	...
	/*charge_test sysfs*/
	struct device_attribute attr_charge_test;
	int charge_test;
	bool thermal_disable;
	int raw_thermal_level;
#endif
};
