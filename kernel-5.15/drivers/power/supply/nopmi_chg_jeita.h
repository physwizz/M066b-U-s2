...
/* sw jeita */
#define JEITA_TEMP_ABOVE_T4_CV	4200
#define JEITA_TEMP_T3_TO_T4_CV	4200
#define JEITA_TEMP_T2_TO_T3_CV	4340
#define JEITA_TEMP_T2_TO_T3_P_CV	4160
...
#define JEITA_TEMP_NORMAL_VOLTAGE	4350
#define TEMP_T4_THRES  50
#define TEMP_T4_PLUS_THRES  45
...
#define TEMP_T2_TO_T3_P_FCC   5500
#define TEMP_T3_TO_T4_FCC   2210
#define JEITA_WORK_DELAY_MS		1500
#define TEMP_T3_PLUS_FCC    4000

#define MAIN_QUICK_CHARGE_ITERM  240
#define MAIN_CHARGE_ITERM        240

enum {
	BATT_VOLTAGE,
	BATT_VOLTAGE_3_TO_3P5,
	BATT_VOLTAGE_3P5_TO_4P16,
	BATT_VOLTAGE_4P16_TO_4P25,
	BATT_VOLTAGE_4P25_TO_4P28,
	BATT_VOLTAGE_4P28_ABOVE,
};
...
struct nopmi_chg_jeita_config{
	...
	int temp_t3_plus_fcc;
	int temp_t2_to_t3_p_fcc;
	int jeita_temp_t2_to_t3_p_cv;
};
