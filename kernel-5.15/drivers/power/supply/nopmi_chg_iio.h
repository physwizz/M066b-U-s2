...
#define SC8541_IIO_CHANNEL_OFFSET CHARGE_PUMP_SC_CHARGING_ENABLED
static const char * const cp_ext_iio_chan_name[] = {
	...
	[CHARGE_PUMP_UP_BUS_CURRENT] = "upm6722_bus_current", //upm6720 ibus
	[CHARGE_PUMP_UP_BUS_VOLTAGE] = "upm6722_bus_voltage",     //upm6720 vbus
	[CHARGE_PUMP_UP_BATTERY_VOLTAGE] = "upm6722_battery_voltage", //upm6720 voltage

	[CHARGE_PUMP_SC_CHARGING_ENABLED] = "sc_charging_enabled",
	//[CHARGE_PUMP_LN_CHIP_ID] = "ln_chip_id",
	[CHARGE_PUMP_SC_BUS_CURRENT] = "sc_bus_current", //upm6720 ibus
	[CHARGE_PUMP_SC_BUS_VOLTAGE] = "sc_bus_voltage",     //upm6720 vbus
	[CHARGE_PUMP_SC_BATTERY_VOLTAGE] = "sc_battery_voltage", //upm6720 voltage
