...
def main(**args):
    ...
    lct_build_mode = args["lct_build_mode"]
    ...
    if lct_build_mode == 'factory':
        mode_config += ' %s.config' % (lct_build_mode)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lct-build-mode", dest="lct_build_mode", help="specify the lct build mode to build kernel.", default="")
